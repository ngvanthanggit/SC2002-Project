...
public class HMSApp {
    ...
    public static void main(String[] args){
          ...
          * Depending on the role of the person, we will call the corresponding classes/methods
          */
    ...
    public static void mainCreateAcc(List<User> admins, List<User> patients){
        ...
        if(newCreatedUser!= null && newCreatedUser instanceof Patient){
            ...
            PatientsAcc.addPatient((Patient) newCreatedUser); //cast to Patient, add to patient List & write into CSV database
        } else if(newCreatedUser!= null && newCreatedUser instanceof Administrator){
            System.out.println("New account created!");
            AdminsAcc.addAdmin((Administrator)newCreatedUser); //cast to Admin add to staff List & write into CSV database
        } else {
