...
public class SystemInitialisation {
    ...
    /**
     * A centralized map for storing file paths associated with various components in the system.
     * <p>
     * The {@code filePaths} map provides a single source of truth for file path management, 
     * reducing hardcoding and enhancing maintainability. Each key-value pair in the map 
     * associates a unique identifier (e.g., "AdminsOriginal") with its corresponding file path.
     */
    private static final Map<String, String> filePaths = new HashMap<>();
    
    /**
     * Static initializer block for populating the {@code filePaths} map with file paths.
     * <p>
     * This block initializes the map with predefined keys and their respective file paths. 
     * The keys represent different entities and operations in the system (e.g., "AdminsOriginal", "DoctorsUpdated").
     * <p>
     * Example:
     * <ul>
     *   <li>{@code "AdminsOriginal"} maps to the original administrator list file path.</li>
     *   <li>{@code "DoctorsUpdated"} maps to the updated doctor list file path.</li>
     * </ul>
     * 
     * The use of this map ensures centralized and consistent management of file paths across the application.
     */
    static {
        //Administrator Files
     ...
     * 
     * @param key The key representing the desired file path (e.g., "AdminsOriginal", "AdminsUpdated").
     * @return The file path associated with the provided key, or {@code null} if the key does not exist.
     */
