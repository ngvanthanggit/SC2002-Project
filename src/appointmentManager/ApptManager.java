...
// private static final String updatedPath =
// "../Data//Updated/Appt_List(Updated).csv";
...
// List<Appointment> apptMapList = CSVread.readApptCSV(filePath,
// apptColumnMapping);
...
// * Appointment appt = Appointment.fromCSV(line); // Assuming you have this
// * method
...
// * bw.write(
// *
// "AppointmentID,PatientID,DoctorID,Date,Time,Status,ConsultationNotes,PrescribedMedications,ServiceType"
// * ); // Header
// * bw.newLine();
// * } catch (IOException e) {
// * e.printStackTrace();
...
// * // remove later
// * System.out.println("Attempting to remove appointment with ID: " +
// * appointmentID);
// *
// * // Filter out the appointment to remove
// * List<Appointment> updatedAppointments = appointments.stream()
// * .filter(a -> a.getAppointmentID() != appointmentID) // remove the matching
// * appt using appointmentID
// * .collect(Collectors.toList());
// *
// * // remove later
// * System.out.println("Appointments after removal: " +
...
// * // appointments = loadAllAppointments();
// * // remove later
// * System.out.println("Rewriting CSV with " + appointments.size() +
// * " appointments.");
// * //clearCSV();
...
// * // remove later
// * System.out.println("Saving appointment with ID: " +
// * appointment.getAppointmentID() + " to CSV.");
// *
...
// * List<Appointment> appointments = loadAllAppointments(); // Load all
...
// * appointments.set(i, updatedAppointment); // Replace with updated
// appointment
// * break;
// * }
// * }
...
// * appointment.getStatus().equals(Appointment.Status.CONFIRMED)) {
...
// * appointments = loadAllAppointments();
// * for (Appointment appointment : appointments) {
// * if (appointment.getDoctor().getHospitalID().equals(hospitalID) ||
// * appointment.getPatient().getHospitalID().equals(hospitalID)) {
