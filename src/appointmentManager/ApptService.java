...
public class ApptService {
    ...
    public void scheduleAppointment(String patientID, String doctorID, LocalDate date, LocalTime time){
        Appointment appointment = scheduler.scheduleAppointment(patientID, doctorID, date, time);
    ...
    public void viewScheduledAppointment(String patientID){
        ...
        boolean hasAppointments = false; // To track if any upcoming appointments are found

        System.out.println("----------------------------------------");
        for (Appointment appointment : appt){
            if (appointment.getPatient().getHospitalID().equals(patientID) && appointment.getDate().isAfter(LocalDate.now())) {
                hasAppointments = true;
                System.out.println("Appointment ID: " + appointment.getAppointmentID());  
                System.out.println("Appointment with doctor " + appointment.getDoctor().getName()); 
    ...
    public void getAllOutcomeRecords(String hospitalID){
        ...
        for (Appointment appointment : pastAppointments){
            ...
            System.out.println("Type of service provided: " + appointment.getServiceType());
            // Add a separator between appointments
            System.out.println("----------------------------------------");
        }
    }
    ...
    public void viewUpcomingAppointment(String doctorID){
        ...
        System.out.println("----------------------------------------");
        for (Appointment appointment : appt){
            if (appointment.getDoctor().getHospitalID().equals(doctorID) && appointment.getDate().isAfter(LocalDate.now())) {
                hasAppointments = true;
                System.out.println("Appointment ID: " + appointment.getAppointmentID());  
                System.out.println("Appointment with patient " + appointment.getPatient().getName()); 
                System.out.println("Status: " + appointment.getStatus());
    ...
    public void recordAppointmentOutcomes(int appointmentID, String consultationNotes, String prescribedMedications, String serviceType) {
        Appointment appointment = repository.findAppointmentByID(appointmentID);
        if (appointment == null) {
    ...
    public void viewAppointmentUpdates() {
        ...
        if (appt.isEmpty()) {
            ...
            for (Appointment appointment : appt) {
                System.out.println("Appointment ID: " + appointment.getAppointmentID());
                System.out.println("Patient: " + appointment.getPatient().getName() + ", " + appointment.getPatient().getHospitalID());
                System.out.println("Doctor: " + appointment.getDoctor().getName()+ ", " + appointment.getDoctor().getHospitalID());
                System.out.println("Status: " + appointment.getStatus());
                System.out.println("Date: " + appointment.getDate());
                System.out.println("Time: " + appointment.getTime());
                System.out.println("Consultation notes: " + appointment.getConsultationNotes());
