...
public class ApptScheduler {
    ...
    public void addAppointment(Appointment appointment) {
        appointments.add(appointment); // assuming appointments is a list storing all the appointments
    }
    

    public Appointment scheduleAppointment(String patientID, String doctorID, LocalDate date, LocalTime time) {
